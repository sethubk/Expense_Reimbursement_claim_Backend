...
namespace Claim_Form.Controllers
{
    ...
    public class DomesticExpenseController : ControllerBase
    {
        ...
        /// <summary>
        /// Creates multiple Domestic expenses for a single claim.
        /// </summary>
        /// <param name="claimId">Claim identifier.</param>
        /// <param name="entries">List of Domestic expense entries.</param>
        ...
        public async Task<IActionResult> GetById([FromRoute] Guid id)
        {
            ...
            try
            {
                var expense = await _domesticService.GetDomesticAsync(id);
